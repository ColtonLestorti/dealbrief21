  ...
  "stories": [
    {
      ...
      "coverage_team": "<OPTIONAL: the bank coverage group most likely to own this — e.g. 'TMT', 'Healthcare', 'FIG', 'Energy & Power', 'Consumer & Retail', 'Industrials', 'Real Estate'; a string or array. Omit to let the site infer it from sector/tags.>",
      "source": "...",
      "source_url": "https://...",
  ...
  "opportunities": [
    {
      ...
      "coverage_team": "<OPTIONAL: covering group most likely to own this — e.g. 'TMT', 'Healthcare', 'FIG', 'Energy & Power', 'Consumer & Retail', 'Industrials', 'Real Estate'; string or array. Omit to let the site infer it from sector/tags.>",
      "source": "...",
      "source_url": "https://...",
      "published": "YYYY-MM-DD (the article's publication date)",
      "confidence": "Filed|Reported|Speculative"
